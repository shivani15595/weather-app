...
const DataTracker = props => {
  ...
  return (
    <div className="dataType">
      {props.type}
      <div className="data">Min : {showMin(props.values)}</div>
      <div className="data">Max : {showMax(props.values)}</div>
      <div className="data">Mean : {showMean(props.values)}</div>
      <div className="data">Mode : {showMode(props.values)}</div>
    </div>
  );
};
